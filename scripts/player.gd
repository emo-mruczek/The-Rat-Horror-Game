...
@onready var items = [
    ...
    ["key_2", $"player-key-2", preload("res://scenes/key_2.tscn")],
    ["key_3", $"player-key-3", preload("res://scenes/key_3.tscn")],
    ["key_4", $"player-key-4", preload("res://scenes/key_4.tscn")],
    ["key_5", $"player-key-5", preload("res://scenes/key_5.tscn")],
]
